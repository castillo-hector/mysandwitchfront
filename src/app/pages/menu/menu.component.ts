...
export class MenuComponent implements OnInit {
  ...
  constructor(public appSettings:AppSettings, public appService:AppService, public mediaObserver: MediaObserver, public appMenuService: ProductoService) {
  ...
  public getMenuItems(){
    this.appMenuService.getMenuItems().subscribe(data => {
